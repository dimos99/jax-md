"""Hard-sphere shear runner mirroring the RPY shear workflow."""
  ...
  *,
  ...
  return {
    'user_args': {
      ...
      # Compatibility fields shared with rpy_shear.py CLI.
      'mr_skin': args.mr_skin,
      'mr_capacity_multiplier': args.mr_capacity_multiplier,
      'xi': args.xi,
    },
    'internal': {
      'a': a,
...
def main():
  ...
  if init_mode == 'data':
    ...
    write_lammps_data(
      ...
      init_pos_real,
      comment=(
        'Generated by examples/rpy_shear/hard_sphere_shear.py '
